...
#SBATCH --job-name=lunar  ## Job name for identification

#SBATCH --output=experiments/slurm_docs/lunar_%j.out  ## Output file with job ID

#SBATCH --error=experiments/slurm_docs/lunar_%j.err  ## Error file with job ID
