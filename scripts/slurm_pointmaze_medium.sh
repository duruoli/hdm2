...
#SBATCH --job-name=pointmaze_medium  ## Job name for identification

#SBATCH --output=experiments/slurm_docs/pointmaze_medium_%j.out  ## Output file with job ID

#SBATCH --error=experiments/slurm_docs/pointmaze_medium_%j.err  ## Error file with job ID
...
# ============================================
# Run Training: PointMaze Medium
# ============================================

# Your project directory on Quest
cd /home/dlf8982/AAA/hdm2

# Run HDM training on pointmaze medium
python -m hdm \
    --env_name pointmaze_medium \
    --independent_policy \
    --greedy_action \
    --use_dqn \
    --double_dqn \
