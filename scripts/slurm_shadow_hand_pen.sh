...
#SBATCH --job-name=shadow_hand_pen  ## Job name for identification

#SBATCH --output=experiments/slurm_docs/shadow_hand_pen_%j.out  ## Output file with job ID

#SBATCH --error=experiments/slurm_docs/shadow_hand_pen_%j.err  ## Error file with job ID
...
# ============================================
# Run Training: Shadow Hand Pen Manipulation
# ============================================

# Your project directory on Quest
cd /home/dlf8982/AAA/hdm2

# Run HDM training on shadow hand pen manipulation
python -m hdm \
