...
#SBATCH --job-name=metaworld_push  ## Job name for identification

#SBATCH --output=experiments/slurm_docs/metaworld_push_%j.out  ## Output file with job ID

#SBATCH --error=experiments/slurm_docs/metaworld_push_%j.err  ## Error file with job ID
...
# Run HDM training on metaworld_push
python -m hdm \
