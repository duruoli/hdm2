"""
GymGoalEnvWrapper - converts Dict observation spaces to flat goal-conditioned states.

Copied from GCSL to avoid dependencies on old mujoco_py.
"""
...
class GymGoalEnvWrapper(GoalEnv):
    """
    A wrapper around environments with Dict observation spaces that flattens
    them into a single state vector: [observation, goal, state_goal].
    
    This converts multiworld-style environments (github.com/vitchyr/multiworld) 
    and gym GoalEnvs into the GoalEnv format expected by GCSL/HDM.
    """
    
    def __init__(self, base_env, observation_key='observation', goal_key='achieved_goal', 
        ...
        # Concatenate observation and goal to get the state
    ...
    def goal_distance(self, state, goal_state):
        ...
        Uses state_goal_key to determine distance (useful for images).
        """
